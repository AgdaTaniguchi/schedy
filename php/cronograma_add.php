...
if($err == false){
    try{        
        ...
        forEach($dias_semana as $cont){
            $comando = $conexao->prepare("INSERT INTO evento (titulo, descricao, dia_semana, horario, receber_notificacao, cor, id_cronograma) VALUES (?, ?, ?, ?, ?, ?, ?)");
            ...
            $comando -> bindParam(7, $id_cronograma);
